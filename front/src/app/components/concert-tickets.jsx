        ...
        <div className="container mx-auto text-center">
          {isLoggedIn ? (
            <h2 className="text-4xl font-bold mb-4">
              ¡Hola, Usuario de Spotify!
            </h2>
          ) : (
            <h2 className="text-4xl font-bold mb-4">
              Find Your Next Concert Experience
            </h2>
          )}
          <p className="text-xl mb-8">
            Discover amazing artists and unforgettable performances
          </p>
          ...
          {currentArtists.map((artist) => (
            <Card key={artist.artist_id} className="flex flex-col">
              ...
              <CardContent className="p-4 pt-0">
                ...
                <p className="text-sm">
                  <strong>Date:</strong> {artist.concert_date}
                </p>
                <p className="text-sm">
                  <strong>Time:</strong> {artist.concert_time}
                </p>
              </CardContent>
      ...
      <footer className="bg-muted text-muted-foreground p-8">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm">
              ConcertTix is your go-to platform for the best concert
              experiences.
            </p>
          </div>
          <div>
